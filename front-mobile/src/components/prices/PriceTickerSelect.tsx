      ...
      <div className="flex items-center justify-between gap-4 border-b border-white/[0.05] bg-[var(--surface-2)]/30 px-6 py-5">
        ...
        {selectedPrice && (
          <div className="flex items-center gap-2 rounded-xl border border-orange-500/20 bg-orange-500/8 px-3 py-1.5">
            <span className="font-mono text-[13px] font-black text-orange-400">
              {selectedPrice.ticker}
            </span>
            <span className="font-mono text-[13px] font-bold text-[var(--text-muted)]">
              {useMoney(selectedPrice.price)}
            </span>
          </div>
        )}
      </div>
                ...
                >
                  <span className="flex items-center gap-3">
                    ...
                    <span className="flex flex-col">
                      <span
                        className={`font-mono text-[14px] font-black ${isSelected ? 'text-orange-400' : 'text-[var(--text)]'}`}
                      >
                        {price.ticker}
                      </span>
