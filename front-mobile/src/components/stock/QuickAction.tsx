...
export function QuickAction({ company, price }: Props) {
  ...
  return (
    <div className="p-5 rounded-2xl sticky top-4 bg-[var(--surface)] border border-[var(--border)]">
      ...
      <p
        className="mb-4 font-mono font-bold text-[var(--primary)]"
        style={{ fontSize: 28 }}
      >
      ...
      <div className="flex items-center gap-2 mb-5">
        ...
        <span className="flex-1 text-center font-bold font-mono text-[var(--text)]">
          {qty}
        </span>
        <button
      ...
      <p
        className="font-bold mb-4 font-mono text-[var(--text)]"
        style={{ fontSize: 15 }}
      >
        {price
      ...
      <button
        ...
        style={
          inWatchlist ? { backgroundColor: 'var(--primary-soft)' } : undefined
        }
      >
        <Star
          size={14}
          fill={inWatchlist ? 'var(--primary)' : 'none'}
