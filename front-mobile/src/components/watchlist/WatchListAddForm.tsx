    ...
    <div data-testid="add-ticker-form" className="relative z-20 mb-6">
      <div className="flex gap-3">
        ...
        <button
          ...
          onClick={() => {
            if (query.trim()) onAdd(query.trim());
          }}
      ...
      {error && (
        <div
          ...
          className="mt-3 flex items-center gap-2 rounded-xl border border-rose-500/25 bg-rose-500/8 px-4 py-2.5 text-sm text-rose-300"
        >
      ...
      {success && !error && (
        <div
          ...
          className="mt-3 flex items-center gap-2 rounded-xl border border-emerald-500/25 bg-emerald-500/8 px-4 py-2.5 text-sm text-emerald-300"
        >
