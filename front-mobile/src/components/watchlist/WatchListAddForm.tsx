...
export function WatchlistAddForm({
    ...
    return (
        <div data-testid="add-ticker-form" className="relative z-20 mb-6">
            ...
            {error && (
                <div data-testid="add-error" className="mt-3 flex items-center gap-2 rounded-xl border border-rose-500/25 bg-rose-500/8 px-4 py-2.5 text-sm text-rose-300">
                    <AlertCircle size={14} className="shrink-0" />
                    {error}
                </div>
            )}
            {success && !error && (
                <div data-testid="add-success" className="mt-3 flex items-center gap-2 rounded-xl border border-emerald-500/25 bg-emerald-500/8 px-4 py-2.5 text-sm text-emerald-300">
