...
export function TransactionPanel({
  ...
  const tickerTransactions = useTickerTransactions(
    selectedPrice?.ticker ?? null,
  );
  ...
  return (
    <section
      ...
      className="relative flex h-full flex-col overflow-hidden rounded-3xl border border-white/[0.06] bg-[var(--surface)]/60 shadow-2xl backdrop-blur-xl"
    >
      {/* Glow accent */}
      ...
      <div className="relative z-10 flex items-center gap-3 border-b border-white/[0.05] bg-[var(--surface-2)]/30 px-6 py-5">
        ...
        <div>
          <h2 className="text-[17px] font-black tracking-tight text-[var(--text)]">
            Terminal
          </h2>
      ...
      <div className="relative z-10 flex flex-col gap-5 overflow-y-auto p-6">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/[0.06] bg-[var(--bg-deep)]/70 p-5">
          ...
          <div className="relative">
            ...
            <p
              data-testid="transaction-selected-ticker"
              className="mt-1.5 font-mono text-[32px] font-black leading-none text-[var(--text)]"
            >
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            data-testid="transaction-buy-btn"
            type="button"
            disabled={!canSubmit}
          ...
          <button
            data-testid="transaction-sell-btn"
            type="button"
            disabled={!canSubmit}
        ...
        {actionError && (
          <div
            ...
            className="flex items-start gap-3 rounded-xl border border-rose-500/25 bg-rose-500/8 px-4 py-3 text-[13px] text-rose-300"
          >
            <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-rose-500/20 text-xs font-black text-rose-400">
              !
            </span>
        ...
        {lastAction && !actionError && (
          <div
            ...
            className="flex items-center justify-center gap-2 rounded-xl border border-emerald-500/25 bg-emerald-500/8 px-4 py-3 text-[13px] font-semibold text-emerald-300"
          >
