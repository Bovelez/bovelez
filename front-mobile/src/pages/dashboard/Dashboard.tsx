              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      <span
                        data-testid="transaction-ticker"
                        className="font-mono text-[13px] font-bold text-[var(--text)]"
                      >
                        {t.ticker}
                      </span>
                      <span
                        className={`text-[10px] font-bold px-1.5 py-0.5 rounded ${isBuy ? 'bg-emerald-500/15 text-emerald-400' : 'bg-rose-500/15 text-rose-400'}`}
                      >
                        {isBuy ? 'Compra' : 'Venta'}
                      </span>
                    </div>
