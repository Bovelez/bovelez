    ...
    return (
      ...
      >
        <div className="w-full max-w-sm text-center">
          ...
          <button
            data-testid="buyflow-go-portfolio"
    ...
    >
      ...
      <div className="flex items-center gap-3 px-4 pt-5 pb-4 border-b border-[var(--border)]">
        ...
        <div>
          <p className="font-semibold text-[var(--text)]">
            Comprar {company.ticker}
          </p>
          <p className="text-xs text-[var(--text-muted)]">
            Precio actual: ${price.price.toFixed(2)}
          </p>
        </div>
      </div>
      ...
      <div className="px-4 pt-5 space-y-4">
        ...
        <div className="p-5 rounded-2xl bg-[var(--surface)] border border-[var(--border)]">
          ...
          <input
            data-testid="buyflow-date-input"
            type="date"
            value={date}
        ...
        >
          <p className="text-sm mb-1 text-[var(--text-faint)]">
            Total a invertir
          </p>
          <p
            data-testid="buyflow-total"
            className="font-mono font-bold text-[var(--primary)] text-4xl"
          >
        ...
        <div className="flex gap-3 pt-2">
          ...
          <button
            data-testid="buyflow-confirm-btn"
